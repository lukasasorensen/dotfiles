...
map("n", "<leader>C", live_grep_args_shortcuts.grep_word_under_cursor, { desc = "Telescope Find Word Under Cursor" })
map("v", "<leader>fv", live_grep_args_shortcuts.grep_visual_selection, { desc = "Telescope Grep for Visual Selection" })
map("v", "<leader>V", live_grep_args_shortcuts.grep_visual_selection, { desc = "Telescope Grep for Visual Selection" })
map('n', '<leader>rr', telescope_builtin.resume, { desc = 'Telescope: resume last picker' })
map('n', '<leader>r/', telescope_builtin.search_history,   { desc = 'Telescope: / history' })
map('n', '<leader>r;', telescope_builtin.command_history,  { desc = 'Telescope: : history' })
